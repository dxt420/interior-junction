...
/* harmony import */ var _pages_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/services/auth-guard.service */ "./src/app/pages/services/auth-guard.service.ts");
...
var routes = [
    { path: '', loadChildren: './pages/tabs/tabs.module#TabsPageModule', canActivate: [_pages_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]] },
    ...
    { path: 'tab1', loadChildren: './pages/tab1/tab1.module#Tab1PageModule', canActivate: [_pages_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]] },
    { path: 'tab2', loadChildren: './pages/tab2/tab2.module#Tab2PageModule', canActivate: [_pages_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]] },
    { path: 'tab3', loadChildren: './pages/tab3/tab3.module#Tab3PageModule', canActivate: [_pages_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]] },
    { path: 'tab4', loadChildren: './pages/tab4/tab4.module#Tab4PageModule', canActivate: [_pages_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_2__["AuthGuardService"]] },
];
...
module.exports = ":host ion-content {\n  --background: var(--ion-color-primary); }\n\n:host ion-list.list-md {\n  padding: 0; }\n\n:host ion-icon[class*=\"custom-\"] {\n  margin: 0 5px 0 0;\n  vertical-align: middle;\n  width: 20px;\n  height: 20px; }\n\n:host ion-icon[class*=\"google\"] {\n  background: url('ionic4start-ico.png') no-repeat 50% 50%;\n  background-size: contain; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, navCtrl, authenticationService, router, fAuth) {
        ...
        this.platform.ready().then(function () {
            ...
            _this.fAuth.authState.subscribe(function (user) {
                if (user) {
                    ...
                    console.log(user);
                    _this.displayName = firebase__WEBPACK_IMPORTED_MODULE_7__["database"]().ref().child("users").child(user.uid).once('value').then(function (snapshot) {
                        console.log(snapshot.val().displayName);
                        return (snapshot.val() && snapshot.val().displayName) || ' ';
                    });
                    ;
                    _this.pic = firebase__WEBPACK_IMPORTED_MODULE_7__["database"]().ref().child("users").child(user.uid).once('value').then(function (snapshot) {
...
/* harmony import */ var _pages_modal_search_filter_search_filter_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./pages/modal/search-filter/search-filter.module */ "./src/app/pages/modal/search-filter/search-filter.module.ts");
/* harmony import */ var _components_notifications_notifications_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/notifications/notifications.component */ "./src/app/components/notifications/notifications.component.ts");
...
/* harmony import */ var _pages_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./pages/services/auth-guard.service */ "./src/app/pages/services/auth-guard.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"], _components_notifications_notifications_component__WEBPACK_IMPORTED_MODULE_12__["NotificationsComponent"]],
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_13__["AngularFireModule"].initializeApp(CREDENTIALS),
            ...
            entryComponents: [_components_notifications_notifications_component__WEBPACK_IMPORTED_MODULE_12__["NotificationsComponent"]],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_7__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_6__["SplashScreen"],
                _pages_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_19__["AuthGuardService"],
...
module.exports = ".ion-list.list-ios {\n  margin-bottom: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ":host ion-content {\n  --background: linear-gradient(-135deg, var(--ion-color-medium), var(--ion-color-light))\n  ; }\n\nion-content img {\n  -o-object-fit: cover;\n     object-fit: cover; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/***/ "./src/app/pages/services/auth-guard.service.ts":
/*!******************************************************!*\
  !*** ./src/app/pages/services/auth-guard.service.ts ***!
  \******************************************************/
...
var AuthService = /** @class */ (function () {
    ...
    function AuthService(navCtrl, loadingCtrl, fAuth, router, storage, platform, toastController, menuCtrl, toastCtrl, alertCtrl, fb, gplus) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.fb = fb;
        this.gplus = gplus;
        this.authState = new rxjs__WEBPACK_IMPORTED_MODULE_9__["BehaviorSubject"](false);
        this.platform.ready().then(function () {
            _this.ifLoggedIn();
        });
    }
    ...
    AuthService.prototype.register = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var r, ref, data, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.fAuth.auth.createUserWithEmailAndPassword(user.email, user.password)];
                    case 1:
                        r = _a.sent();
                        if (r) {
                            console.log("Successfully registered!");
                            ref = firebase__WEBPACK_IMPORTED_MODULE_3__["database"]().ref().child("users");
                            data = {
    ...
    AuthService.prototype.login = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var r, dummy_response, err_2;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.fAuth.auth.signInWithEmailAndPassword(user.email, user.password)];
                    case 1:
                        r = _a.sent();
                        if (r) {
                    ...
                    case 2:
                        err_2 = _a.sent();
                        console.error(err_2);
                        if (err_2.code == 'auth/invalid-email') {
                            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
                                title: 'Login Failed',
    ...
    AuthService.prototype.loginWithFacebook = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, fbCredential, a, ref, data, dummy_response, err_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.fb.login(['email'])];
                    case 1:
                        result = _a.sent();
                        fbCredential = firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].FacebookAuthProvider.credential(result.authResponse.accessToken);
                        return [4 /*yield*/, firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().signInWithCredential(fbCredential)];
                    case 2:
                        a = _a.sent();
                        if (a) {
                            console.log("Successfully logged in!");
                    ...
                    case 3:
                        ...
                        console.log(err_3);
                        console.error(err_3);
                        console.error(err_3.errorMessage);
                        if (err_3.errorMessage == 'Facebook error: net::ERR_CONNECTION_TIMED_OUT') {
                            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire({
                                title: 'Login Failed',
    ...
    AuthService.prototype.nativeGoogleLogin = function () {
        return __awaiter(this, void 0, void 0, function () {
            var gplusUser, a, dummy_response, err_4;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        gplusUser = _a.sent();
                        return [4 /*yield*/, this.fAuth.auth.signInWithCredential(firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].GoogleAuthProvider.credential(gplusUser.idToken))];
                    case 2:
                        a = _a.sent();
                        if (a) {
                            console.log("Successfully logged in!");
...
module.exports = __webpack_require__(/*! /Users/mbpr/Downloads/ij/src/main.ts */"./src/main.ts");
